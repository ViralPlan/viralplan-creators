<template>
    ...
    <p>Estás intentando borrar la compañía <strong>{{ companyStore.companySelected }}</strong>. Al hacerlo, se borrarán todos los planes asociados a esta.
    Esta operación solo debe hacerse en caso de que la persona competente haya solicitado el borrado de los datos, NO si
    esta ha dejado de ser cliente de ViralPlan. ¿Deseas proceder?
    </p>
    <button v-on:click="() => {
        deleteCompany({
