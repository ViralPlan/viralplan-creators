  ...
  const schema = {
    ...
    properties: {
      ...
      duracion: {
        type: 'string',
        description:
          'Duracion del video, ajustándose a lo que durará el guión escrito más abajo',
      },
      personas: {
        type: 'number',
        description:
          'Numero de personas que aparecen en el video, que como máximo debe ser el número de personas que aparecen en la información de la empresa',
      },
      lugares: {
        type: 'string',
        description:
          'Lugares donde se graba el video, de entre los que estan disponibles en la información de la empresa',
      },
      descripcion: {
        type: 'string',
        description:
          'Texto que debe ir incluido en la descripcion del video una vez subido a Tiktok',
      },
      planos: {
        type: 'array',
        description:
          ' Cadena de texto donde se define, para cada plano: tiempos de cada plano, acting de cada persona en el plano, dialogos/voz en off en cada plano, tono a transmitir en cada plano',
        items: { type: 'string' },
      },
      texto: {
        type: 'string',
      ...
      objetivo: {
        type: 'string',
        description:
          'Objetivo del video, que debe ir acorde con la información dada de la empresa (vender, aumenar seguidores, etc)',
      },
      cta: {
        type: 'string',
        description:
          'Call to action del video, que debe ir acorde con el objetivo',
      },
      punchline: {
        type: 'string',
        description:
          'Punchline del video final, que puede ir incluida o no en el texto en pantalla',
      },
      extra: {
        type: 'string',
      ...
      instrucciones: {
        type: 'array',
        description:
          'Instrucciones de acting del video, dadas para cada persona que sale en el video sobre como comportarse de manera general',
        items: { type: 'string' },
      },
    },
    required: [
  ...
  const chatCompletion = await openai.chat.completions.create({
    messages: [
      ...
      },
      {
        role: 'assistant',
        content:
          'Entendido, estoy aquí para ayudarte con tus necesidades de creación de contenido y marketing digital viral. Esperaré tu información y tus instrucciones. Estoy listo para empezar cuando tú lo estés.',
      },
      {
        role: 'user',
        content:
          'A continuación, te proporciono detalles específicos de una empresa cliente: ' +
          company,
      },
      {
        role: 'assistant',
        content:
          'Toda la información está retenida, estoy listo para recibir tus instrucciones adicionales y proceder cuando indiques con la palabra clave "GENERA".',
      },
      {
        role: 'user',
        content:
          `Con la información proporcionada, GENERA el guión de el siguiente video de Tiktok para la empresa que trate sobre la siguiente idea: ` +
          idea,
      },
    ],
    model: 'gpt-4',
